...
SECRET_KEY = config(
    "SECRET_KEY",
    default="django-insecure-_gm^wxqbv0g-bhxwe7@4q@+*l@bay653!37#yar8&__$iatxe7"
)
...
if config("DATABASE_URL", default=None):
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": config("DB_NAME", default="obavezeDB"),
            "PASSWORD": config("DB_PASSWORD", default="SoftInz1"),
